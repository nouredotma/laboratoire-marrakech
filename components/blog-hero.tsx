      ...
      <div className="container mx-auto px-4 py-10 sm:py-16 md:py-24">
        <div className="text-white">
          ...
          <div className="max-w-3xl">
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-2 sm:mb-4">Blog</h1>
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-3 sm:p-4 rounded-lg mb-4 sm:mb-6">
              <p className="text-xs sm:text-base">
                Découvrez nos derniers articles sur la santé, les analyses médicales et les conseils pour prendre soin
                de vous. Notre équipe de professionnels partage régulièrement des informations utiles pour vous aider à
